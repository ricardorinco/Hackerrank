...
namespace Hackerrank.Tests
{
    ...
    {
        [Theory]
        [InlineData(2, 7, new[] { 1, 2, 1, 2, 1, 3, 2 })]
        [InlineData(3, 9, new[] { 10, 20, 20, 10, 10, 30, 50, 10, 28 })]
        [InlineData(4, 10, new[] { 1, 1, 3, 1, 2, 1, 3, 3, 3, 3 })]
        [InlineData(4, 14, new[] { 4, 8, 4, 8, 4, 8, 4, 4, 8, 7, 8, 9, 10, 22 })]
